...
countAxis.title.text = "Sea Level";
countAxis.renderer.minGridDistance = 100;
// countAxis.renderer.grid.template.disabled = true;

var sea_temp_Axis = chart.yAxes.push(new am4charts.DurationAxis());
sea_temp_Axis.title.text = "Sea Temperature";
// sea_temp_Axis.baseUnit = "minute";
sea_temp_Axis.renderer.grid.template.disabled = true;
sea_temp_Axis.renderer.opposite = true;
sea_temp_Axis.syncWithAxis = countAxis;
...
cat_1_Series.dataFields.valueY = "Projected_Sea_tmp";
cat_1_Series.dataFields.dateX = "Year";
cat_1_Series.yAxis = sea_temp_Axis;
cat_1_Series.name = "Sea Temp";
